...
namespace GameTraktor {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseButtonReleased>(GT_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleasedEvent));
		...
		dispatcher.Dispatch<WindowResizedEvent>(GT_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
	}

	bool ImGuiLayer::OnMouseButtonPressedEvent(MouseButtonPressedEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
		io.MouseDown[e.GetMoustButton()] = true;
	...
	{
		ImGuiIO& io = ImGui::GetIO();
		io.MouseDown[e.GetMoustButton()] = false;
